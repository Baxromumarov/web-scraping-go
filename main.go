...
// PokemonProduct defining a data structure to store the scraped data
...
func main() {
	...
	pageToScrape := "https://uzum.uz/uz/category/elektronika-10020?currentPage=1"
	...
	fmt.Println("LEN ,", len(pokemonProducts))
